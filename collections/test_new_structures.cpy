...
def main() -> int:
    ...
    void* _ga = lfu_cache_get(lfu, 1)
    void* _gb = lfu_cache_get(lfu, 1)
    ...
    sm = sparse_matrix_set(sm, 0, 0, (void*)7)
    sm = sparse_matrix_set(sm, 1, 1, (void*)8)
    sm = sparse_matrix_set(sm, 2, 2, (void*)9)
    void* mv = sparse_matrix_get(sm, 1, 1)
    void* mz = sparse_matrix_get(sm, 0, 3)
    if (size_t)mv == (size_t)8 and mz == 0 and sparse_matrix_size(sm) == 3:
